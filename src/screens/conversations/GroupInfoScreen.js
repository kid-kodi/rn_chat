  ...
  const formik = useFormik({
    ...
    onSubmit: async values => {
      ...
      if (response.success) {
        ...
        navigation.navigate('CHAT', { chatId: response.data._id, userId: undefined });
      } else {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.stickyButtonContainer}>
        <TouchableOpacity style={styles.stickyButton} onPress={formik.handleSubmit}>
          <Text style={styles.stickyButtonText}>Créer</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
