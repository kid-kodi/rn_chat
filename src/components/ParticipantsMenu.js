      ...
      <View style={{flexDirection: 'row', alignItems: 'center', padding: 20}}>
        ...
        <View style={participantsMenuStyles.nameContainer}>
          ...
          {MeetingVariable.hostId === peerInfo.id && (
            <FontAwesome5
              name={'crown'}
              color={'gold'}
              style={participantsMenuStyles.hostIcon}
            />
          )}
        </View>
        <View style={participantsMenuStyles.iconContainer}>
          ...
          <Ionicons
            ...
            size={20}
            style={participantsMenuStyles.icon}
            color={item.hasVideo() ? '#9be3b1' : '#aaaaaa'}
          />
        </View>
      </View>
    );
      ...
      <View style={{flexDirection: 'row', alignItems: 'center', padding: 20}}>
        ...
        <View style={participantsMenuStyles.iconContainer}>
          <Ionicons
            ...
            size={20}
            style={participantsMenuStyles.icon}
            color={myMicStat ? '#9be3b1' : '#aaaaaa'}
          />
          <Ionicons
            name={'videocam'}
            size={20}
            style={participantsMenuStyles.icon}
            color={myCamStat ? '#9be3b1' : '#aaaaaa'}
          />
        </View>
      </View>
      <View style={{alignItems: 'center'}}>
        <Text>
          参会人数：{MeetingVariable.mediaService.getPeerDetails().length + 1}
        </Text>
      </View>
      <FlatList
