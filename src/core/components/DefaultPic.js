...
export const DefaultPic = ({style, imgSrc = null}) => {
  ...
  return (
    <View
      ...
      {imgSrc == null ? (
        <Image
          source={require('../../assets/images/greylogoTrans.png')}
          style={{width: imgScale / 3, height: imgScale / 3}}
        />
      ) : (
        <Image
          source={{uri: imgSrc}}
...
export const DefaultWithAudioPic = ({style, imgSrc = null}) => {
  ...
  return (
    <View
      ...
      <ImageBackground
        source={require('../../assets/images/AudioBg.png')}
        style={{
          width: imgScale * 0.9,
          height: imgScale * 0.9,
          alignItems: 'center',
